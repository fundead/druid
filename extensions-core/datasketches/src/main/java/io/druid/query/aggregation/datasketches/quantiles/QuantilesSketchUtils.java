...
public class QuantilesSketchUtils
{
  ...
  public static Union buildUnion(int size)
  {
    return Union.builder().build(new QuantilesSketchBuilder().build(size));
  }

  public static QuantilesSketch buildSketch(int size)
  {
    return new QuantilesSketchBuilder().build(size);
  }
}
